...
prompt = f"You are a excellent in the {topic}. Now a person wants to learn the same topic in {time}. He/She has {level} level of knowledge in the field. Now generate a roadmap with references and tags (tags must be related to the topic) for the person. Show detailed pat and all tags should start with '#' only and in an array format, Like [#john, #doe].\n"
